                                ...
                                <div class="form-validation">
                                    <form class="form-valide" action="insertarDulce.php" method="POST">
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="val-skill">Gamer<span class="text-danger">*</span>
                                            </label>
                                            <div class="col-lg-6">
                                      ...
                                      <!-- <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                         ...
                                         <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="val-username">Cantidad <span ></span>
                                            </label>
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="canti" name="canti" placeholder="">
                                            </div>
                                        </div>

                                        
                                         <div class="form-group row">
                                            <label class="col-lg-4 csol-form-label" for="val-username">Precio por producto:  <span></span>
                                            </label>
                                            <div class="col-lg-6">
                                                <?php ?>
