<?php
    ...
    $query = "SELECT id, nombre FROM plataformas";
...
<head>
    ...
    <title>Revoluxion-Registrar Consola</title>
    <!-- Favicon icon -->
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="form-validation">
                                    <form class="form-valide" action="_insertar.php" method="POST">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="form-validation">
                                    <form class="form-valide" action="_insertar.php" method="POST">
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="val-skill">Plataforma<span class="text-danger">*</span>
                                            </label>
                                            <div class="col-lg-6">
                                                <select class="form-control" id="val-usernam" name="val-usernam">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="val-username">Numero serial<span ></span>
                                            </label>
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="seria" name="seria" placeholder="Numero serial">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="val-username">Numero Identificador <span ></span>
                                            </label>
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="identi" name="identi" placeholder="Numero Identificador">
                                            </div>
                                        </div>
                                        
                                        <div class="form-group row">
                                            <div class="col-lg-8 ml-auto">
                                                <button type="submit" class="btn btn-primary">Ingresar Consola</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
