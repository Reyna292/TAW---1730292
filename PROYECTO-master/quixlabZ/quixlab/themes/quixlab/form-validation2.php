                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="form-validation">
                                 ...
                                 <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="val-username">Costo en Monedas<span class="text-danger">*</span>
                                            </label>
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="val-costo" name="correo" placeholder="">
                                            </div>
                                        </div>
